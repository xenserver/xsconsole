...
# countries.
#
# Generated by GenerateXSConsoleLangFriendlyNames.rb Tue Aug 05 10:52:16 +0100 2008
# from FriendlyNames.resx last modified Wed Jul 23 17:33:06 +0100 2008
...
class LangFriendlyNames:
  ...
  friendlyNamesMap = {
    ...
    'Description-host.system_status-X11-auth' : 'The details of X11 authority',
    ...
    'Description-host.system_status-high-availability' : 'High availability data',
    ...
    'Description-host.system_status-persistent-stats' : 'This enables collection of RRD performance data stored in dom0',
    ...
    'Description-host.system_status-system-services' : 'The details of system services',
    ...
    'Description-host.system_status-xen-info' : 'Details of the hypervisor version and it\'s current state',
    ...
    'Description-host.system_status-xha-liveset' : 'The details of HA host that are alive',
    ...
    'Label-VM.VirtualzationState' : 'Virtualization State',
    ...
    'Message.action-license_does_not_support_pooling' : 'Apply License',
    ...
    'Message.body-ha_host_was_fenced' : 'Server \'{0}\' could not be contacted and has been fenced',
    'Message.body-ha_network_bonding_error' : 'Network bond \'{0}\' on pool \'{1}\' has failed, limiting the HA failover capabilities on this pool.',
    'Message.body-ha_pool_drop_in_plan_exists_for' : 'The maximum number of server failures tolerable in pool \'{0}\' has fallen',
    ...
    'Message.body-ha_protected_vm_restart_failed' : 'VM \'{0}\', which is protected under HA, has failed to start.',
    ...
    'Message.body-ha_statefile_lost' : 'HA statefile in pool \'{0}\' has been lost. The pool\'s HA failover functionality is greatly reduced without a statefile.',
    'Message.body-ha_xapi_healthcheck_approaching_timeout' : 'XenServer on server \'{0}\' is taking too long to respond and may fence.',
    'Message.body-host_clock_skew_detected' : 'Server \'{0}\' may have a significantly different clock time compared to other servers in pool \'{1}\'. This may lead to errors when migrating VMs.',
    'Message.body-host_sync_data_failed' : 'Database synchronization on server \'{0}\' failed. Data may be lost if this server is switched off.',
    'Message.body-license_does_not_support_pooling' : 'Server \'{0}\' is unable to become a member of a pool as it does not have the correct license',
    'Message.body-pbd_plug_failed_on_server_start' : 'A storage repository on server \'{0}\' failed to be attached when the server started. Try the Repair Storage option in the Storage menu.',
    'Message.body-pool_master_transition' : 'Server \'{0}\' is now the master of pool \'{1}\'. Connect to the pool through this server from now on.',
    'Message.body-vbd_qos_failed' : 'QoS settings for disk \'{0}\' on vm \'{1}\' could not be obeyed.',
    'Message.body-vcpu_qos_failed' : 'QoS settings for VCPU \'{0}\' on vm \'{1}\' could not be obeyed.',
    'Message.body-vif_qos_failed' : 'QoS settings for network interface \'{0}\' on vm \'{1}\' could not be obeyed.',
    'Message.body-vm_cloned' : 'VM \'{0}\' was cloned successfully',
    'Message.body-vm_crashed' : 'VM \'{0}\' crashed',
    'Message.body-vm_rebooted' : 'VM \'{0}\' was rebooted successfully',
    'Message.body-vm_resumed' : 'VM \'{0}\' was resumed successfully',
    'Message.body-vm_shutdown' : 'VM \'{0}\' was shut down successfully',
    'Message.body-vm_started' : 'VM \'{0}\' was started successfully',
    'Message.body-vm_suspended' : 'VM \'{0}\' was suspended successfully',
    ...
    'Message.name-ha_host_was_fenced' : 'Server Fenced',
    'Message.name-ha_network_bonding_error' : 'HA Network Bonding Error',
    'Message.name-ha_pool_drop_in_plan_exists_for' : 'HA failover capacity reduced',
    'Message.name-ha_pool_overcommitted' : 'HA Overcommited',
    'Message.name-ha_protected_vm_restart_failed' : 'HA Protected VM Failed to Restart',
    'Message.name-ha_statefile_approaching_timeout' : 'HA Statefile Approaching Timeout',
    'Message.name-ha_statefile_lost' : 'HA Statefile Lost',
    'Message.name-ha_xapi_healthcheck_approaching_timeout' : 'XenServer Heathcheck Approaching Timeout',
    'Message.name-host_clock_skew_detected' : 'Server Clock Skew Detected',
    'Message.name-host_sync_data_failed' : 'XenServer Database Synchronization Failed',
