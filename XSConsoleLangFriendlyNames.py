...
# countries.
#
# Generated by GenerateXSConsoleLangFriendlyNames.rb Thu May 08 13:26:18 +0100 2008
# from FriendlyNames.resx last modified Thu Apr 17 10:03:13 +0100 2008
...
class LangFriendlyNames:
  ...
  friendlyNamesMap = {
    ...
    'Description-VM.ha_restart_priority' : 'possible values: "" meaning "don\'t restart"; "best-effort" meaning "try to restart this VM if possible but don\'t consider the Pool to be overcommitted if this is not possible"; and a numerical restart priority (e.g. 1, 2, 3,...)',
    ...
    'Label-SR.SRTypes-lvmofc' : 'LVM over HBA',
    'Label-SR.SRTypes-lvmohba' : 'LVM over HBA',
    ...
    'Label-performance.vif_rx' : 'Network {0} Receive',
    'Label-performance.vif_tx' : 'Network {0} Send',
